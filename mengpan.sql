...
CREATE TABLE `file_info`  (
  `file_id` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `user_id` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `file_md5` varchar(32) CHARACTER SET utf8mb4 NOT NULL,
  `file_pid` varchar(10) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `file_size` bigint NULL DEFAULT NULL,
  `file_name` varchar(200) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `file_cover` varchar(100) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `file_path` varchar(100) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
...
CREATE TABLE `user_info`  (
  `user_id` varchar(15) CHARACTER SET utf8mb4 NOT NULL,
  `nick_name` varchar(20) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
  `password` varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
